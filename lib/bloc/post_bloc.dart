...
import 'package:ft_bloc_infinite_list/bloc/bloc.dart';
import 'package:ft_bloc_infinite_list/models/models.dart';
...
class PostBloc extends Bloc<PostEvent, PostState> {
  ...
  Stream<Transition<PostEvent, PostState>> transformEvents(
    ...
    return super.transformEvents(
      // "debounceTime" came from package:rxdart/rxdart.dart
  ...
  Stream<PostState> mapEventToState(
    ...
    if(event is PostFetched && !_hasReachedMax(currentState)) {
      ...
      print('hasReachedMax = ${_hasReachedMax(currentState)}');
    }
  }
  ...
  Future<List<Post>> _fetchPosts(int startIndex, int limit) async {
    ...
    if(response.statusCode == 200) {
      // json came from import 'dart:convert'; declaration
